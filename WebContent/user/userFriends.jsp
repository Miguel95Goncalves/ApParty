...
<%@ page import="java.util.ArrayList, services.SFriend"%>
<%
...
<div class="container">
	<div class="row">
		...
		<%
			ArrayList FriendInvites = (ArrayList) request.getAttribute("loadFriendInvites");
			...
			for (int i = 0; i < FriendInvites.size(); i++) {
				out.append("<div class='panel panel-default'>" + "<div class='row text-center' Style='margin: 1.5%;'>"
						+ "<div class='col-lg-2'>" + "<img src='images/services/s1.jpg' class='img-circle'"
						+ "alt='Cinque Terre' width='120' height='80'>" + "</div>" + "<div class='col-lg-6'>" + "<h2>"
						+ "<a href='#'>Nome do Gajo</a>" + "</h2>" + "</div>"
